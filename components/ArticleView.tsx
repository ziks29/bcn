      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-10">
            ...
            <div className="mt-12 p-6 bg-zinc-100 border-l-4 border-zinc-400">
                ...
                <p className="font-serif-body italic text-sm text-zinc-700">{article.author} — старший корреспондент «Новостей Округа Блейн», специализирующийся на спорах в пустыне и взрывоопасной журналистике.</p>
            </div>
        </div>
      </div>
    </article>
